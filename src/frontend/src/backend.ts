...
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: bigint, arg1: Time, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllServices(): Promise<Array<ServiceCategory>> {
        if (this.processError) {
            try {
    ...
    async getReviewsByService(arg0: bigint): Promise<Array<Review>> {
        if (this.processError) {
            try {
